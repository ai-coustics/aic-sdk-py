...
class OtelConfig:
    ...
    def export_interval_ms(self, value: builtins.int) -> None:
        ...
        Set to 0 to use the SDK default of 60,000 ms.
        """
    def __new__(cls, enable: builtins.bool, session_id: typing.Optional[builtins.str] = None, export_interval_ms: builtins.int = 0) -> OtelConfig:
        r"""
...
class Processor:
    ...
    """
    def __new__(cls, model: Model, license_key: builtins.str, config: typing.Optional[ProcessorConfig] = None, otel_config: typing.Optional[OtelConfig] = None) -> Processor:
        r"""
...
class ProcessorAsync:
    ...
    """
    def __new__(cls, model: Model, license_key: builtins.str, config: typing.Optional[ProcessorConfig] = None, otel_config: typing.Optional[OtelConfig] = None) -> ProcessorAsync:
        r"""
...
class ProcessorConfig:
    ...
    def variable_block_size(self, value: builtins.bool) -> None:
        ...
        Allows calls shorter than block_size at the cost of added latency.
        """
    def __new__(cls, sample_rate: builtins.int, block_size: builtins.int, variable_block_size: builtins.bool = False) -> ProcessorConfig:
        r"""
    ...
    def __repr__(self) -> builtins.str: ...
    @staticmethod
    def optimal(model: Model, sample_rate: typing.Optional[builtins.int] = None, block_size: typing.Optional[builtins.int] = None, variable_block_size: builtins.bool = False) -> ProcessorConfig:
        r"""
...
class Vad:
    ...
    """
    def __new__(cls, model: Model, license_key: builtins.str, config: typing.Optional[ProcessorConfig] = None, otel_config: typing.Optional[OtelConfig] = None) -> Vad:
        r"""
...
class VadAsync:
    ...
    """
    def __new__(cls, model: Model, license_key: builtins.str, config: typing.Optional[ProcessorConfig] = None, otel_config: typing.Optional[OtelConfig] = None) -> VadAsync:
        r"""
...
def analyzer_pair(model: Model, license_key: builtins.str) -> tuple[Collector, Analyzer]:
    r"""
